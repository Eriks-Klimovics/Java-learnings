...
public class ThirdLesson {
    public static void main(String[] args) {
        ...
        // Conditionals operators in Java

        // if (is, has -> isRaining, is RandomNumber, hasEvenValue)
       boolean isRaining = true;
        ...
        // 1 till 20, print numbers that can be divided by 3 and 5; (chislo delitsa na 3 & 5)
        // print divided by 3
        // print divided by 5
